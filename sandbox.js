...
function displayStartScreen() {
  ...
  console.log('\n   ..::IN THE TERMINAL::..\n');
  prompt('Press enter if you dare to continue or press CTRL + Q any time if you want to run away');
}
...
function displayGallowsTree(life) {
  if (life === 2) {
...
} while (randomWord !== hiddenRandomWord);
